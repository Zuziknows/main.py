...
velke_pismeno_zacatek = [w for w in pouze_slova if w.istitle()]
velka_slova = [w for w in pouze_slova if w.isupper()]
mala_slova = [w for w in pouze_slova if w.islower()]
pocet_cislic = [w for w in pouze_slova if w.isdigit()]
